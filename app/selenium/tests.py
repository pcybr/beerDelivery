...
class web_tests(unittest.TestCase):
	...
	def test_search(self):
		...
		name.send_keys('tester_pete_final')
		age = driver.find_element_by_id("id_age")
		age.send_keys(22)
		username = driver.find_element_by_id("id_username")
		username.send_keys('tester_pete_final')
		password = driver.find_element_by_id('id_password')
		password.send_keys('tester_pete_final')
		...
		search.send_keys('tester_pete_final')
	...
	def test_signup(self):
		...
		age.send_keys(22)
		username = driver.find_element_by_id("id_username")
		username.send_keys('tester_final')
		password = driver.find_element_by_id('id_password')
		password.send_keys('tester_final')
		driver.find_element_by_id("button").click()
		welcome = driver.find_element_by_id('welcome')
		if "Welcome to Goombay Smash Beer Delivery!" == welcome:
			assert True
