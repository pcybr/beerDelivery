...
class TestTrip(TestCase):
	...
	def setUp(self):
		...
		Trip.objects.create(trip_id=12,runner=Person.objects.create(name='Peter',age=20,person_id=200,username='Nic',password='yes'),store=Store.objects.create(store_id=2,location='New York',name='Heaven'),active=True)
